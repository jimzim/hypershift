...
type HostedClusterSpec struct {
	...
	// imageTagMirrorSources specifies image tag mirrors that can be used by cluster
	// nodes to pull content. Images can be pulled from these mirrors only if they are referenced by their tags.
	// When imageTagMirrorSources is set, the controllers will generate a machineConfig.
	// This MachineConfig will be part of every payload generated by the controllers for any NodePool of the HostedCluster.
	// Changing this value will trigger a rollout for all existing NodePools in the cluster.
	// +optional
	// +kubebuilder:validation:MaxItems=255
	...
	// imageDigestMirrorSources specifies image digest mirrors that can be used by cluster
	// nodes to pull content. Images can be pulled from these mirrors only if they are referenced by their digests.
	// When imageDigestMirrorSources is set, the controllers will generate a machineConfig.
	// This MachineConfig will be part of every payload generated by the controllers for any NodePool of the HostedCluster.
	// Changing this value will trigger a rollout for all existing NodePools in the cluster.
	// +optional
	// +kubebuilder:validation:MaxItems=255
...
// ImageTagMirrorSource specifies image tag mirrors that can be used by cluster nodes
type ImageTagMirrorSource struct {
	...
	// mirrors are zero or more locations that may also contain the same images
	// +optional
	// +immutable
	// +kubebuilder:validation:MaxItems=255
	// +listType=set
...
// ImageDigestMirrorSource specifies image digest mirrors that can be used by cluster nodes
type ImageDigestMirrorSource struct {
	// source matches the repository that users refer to, e.g. in image pull specifications
	// +immutable
	// +kubebuilder:validation:MaxLength=255
	// +required
